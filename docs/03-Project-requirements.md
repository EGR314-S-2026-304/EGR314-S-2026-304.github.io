...
| ... | ... | ... | No |
| ... | ... | ... | No |
| User Interface | User is able to input commands into EV-scope manually and device operates according to each command | Switch and sensor inputs cause outputs to sensors, LCD screen, and LEDs | No |
